...
class TestConnect:
    ...
    async def test_connect_success(self):
        ...
        mgr.connect.assert_called_once_with("my-tag", port="/dev/ttyACM0", engagement_path=None)
    ...
    async def test_connect_auto_detect(self):
        ...
        mgr.connect.assert_called_once_with("auto-tag", port=None, engagement_path=None)
